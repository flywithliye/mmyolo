...
from mmdet.datasets import BaseDetDataset, LardDataset
...
class YOLOv5LardDataset(BatchShapePolicyDataset, LardDataset):
    """Dataset for YOLOv5 LARD Dataset.

    We only add `BatchShapePolicy` function compared with LardDataset. See
